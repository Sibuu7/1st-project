from tkinter import *
# putting the formula of efficiency 
def Answer():
    ...
    text1=Message(main,text=t1,bg='black',fg='white',font=('comicsanms 12 bold',10,'bold'),width=5000)
    text2=Message(main,text=t2,bg='black',fg='white',font=('comicsanms 12 bold',10,'bold'),width=5000)
...
main.title('EFFICIENCY OF TRANSFORMER')
loading_parameters = Label(main, text='INPUT VALUES', borderwidth=6, relief=SUNKEN, font='comicsanms 12 bold', padx=25, pady=25,bg='orange')
...
coreloss = Label(main, text="Pi (Iron loss)", font='comicsanms 12 bold', padx=25, pady=12, borderwidth=8, relief=SUNKEN,bg='orange')
culoss_at_fullload = Label(main, text="PcuFL (Copper Loss at Full Load)", font='comicsanms 12 bold', padx=25, pady=12, borderwidth=8, relief=SUNKEN,bg='orange')
